 ...
 */
	...
	public void imgMove27() throws Exception {
		...
		args[0] = new String("http://www.avajava.com/images/avajavalogo.jpg");
		//args[0] = new String("/Users/sheikht/Documents/workspace/PLPHW4/src/images/image1.jpg");
		Runnable instance = CodeGenUtils.getInstance(progname, bytecode, args);
		instance.run();
	}
	...
	public void imgMove2() throws Exception {
		...
		String input = name
				+ " url u {image i frame f integer x integer y \nu -> i; i -> f -> show; \nsleep 5; \nx <- screenwidth;\ny <-  screenheight; \nf -> move (x*3/4,y/4) -> show;\n}";
	...
	public void testIdentChain() throws Exception {
		...
		String[] args = { "true", "345", "89",
				...
				"/Users/sheikht/Documents/workspace/PLPHW4/src/images/image2.jpg",
				"https://www.craigjoneswildlifephotography.co.uk/blog/wp-content/uploads/2010/07/CMJ4893Jpeg-FB.jpg" ,
				"/Users/sheikht/Documents/workspace/PLPHW4/src/images/image3.jpg"}; // create command line argument array
		try {
			Runnable instance = CodeGenUtils.getInstance(name, bytecode, args);
			instance.run();
		} catch (InvocationTargetException e) {
	...
	public void testImageOps() throws Exception {
		...
		String[] args = { "true", "345", "89",
				...
				"/Users/sheikht/Documents/workspace/PLPHW4/src/images/image2.jpg",
				"https://www.craigjoneswildlifephotography.co.uk/blog/wp-content/uploads/2010/07/CMJ4893Jpeg-FB.jpg" ,
				"/Users/sheikht/Documents/workspace/PLPHW4/src/images/image1.jpg"}; // create command line argument array
		try {
			Runnable instance = CodeGenUtils.getInstance(name, bytecode, args);
			instance.run();
		} catch (InvocationTargetException e) {
	...
	public void t5() throws Exception {
		...
		String input = "compProg1 integer a, integer b, integer c, boolean bool0 "
				...
				+ "if(boolA == true)  {\nboolean a a <- boolA; bool0 <- false;"
				+ "while(a != boolB){\ninteger d  integer e c <- 3 + 5; d <- 10 - 1;"
				+ " c <- c * d; e <- d / 3; a <- boolB;"
				+ "if(c > d) { \n    c <- d;     if(c <= d)     {        boolA <- false;    }    "
				+ "if(boolA < boolB)     {        c <- 0;    }}} } "
